...
export function cartridgeaccount_registerSessionCalldata(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function cartridgeaccount_upgrade(a: number, b: number, c: number): void;
export function cartridgeaccount_createSession(a: number, b: number, c: number, d: number): number;
export function cartridgeaccount_estimateInvokeFee(a: number, b: number, c: number): number;
...
export function cartridgeaccount_session(a: number, b: number, c: number, d: number, e: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1c3f27a1d9494d81(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h560d6ca3b02aa441(a: number, b: number, c: number, d: number): void;
